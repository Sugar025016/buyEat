...
const rules = {
  ...
  account: [{ required: true, trigger: 'blur', validator: validatoraccount }],
  ...
  <el-drawer v-model="drawer">
    ...
    <template #default>
      <el-form :model="userParams" :rules="rules" ref="formRef">
        <el-form-item label="用户帳號" prop="account">
          <el-input
            placeholder="请您输入用户帳號"
