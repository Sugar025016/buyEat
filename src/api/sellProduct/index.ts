...
import type { ResponseBoolean, ResponseProductList, SellProduct, SellProductList } from './type'
enum API {
...
export const reqAddOrUpdateSellProduct = (shopId: number,data: SellProduct) => {
  if (data.id) {
